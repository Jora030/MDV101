...
VL_INLINE_OPT void Vfibonacci_generator___024root___nba_sequent__TOP__0(Vfibonacci_generator___024root* vlSelf) {
    ...
    __Vdly__fibonacci_generator__DOT__fib_prev2 = vlSelf->fibonacci_generator__DOT__fib_prev2;
    if (vlSelf->rst) {
        __Vdly__fibonacci_generator__DOT__fib_prev2 = 0U;
        __Vdly__fib_out = 0U;
        vlSelf->fibonacci_generator__DOT__fib_prev1 = 1U;
    } else if (vlSelf->enable) {
        __Vdly__fib_out = (vlSelf->fibonacci_generator__DOT__fib_prev1 
                           + vlSelf->fibonacci_generator__DOT__fib_prev2);
        __Vdly__fibonacci_generator__DOT__fib_prev2 
            = vlSelf->fibonacci_generator__DOT__fib_prev1;
        vlSelf->fibonacci_generator__DOT__fib_prev1 
            = vlSelf->fib_out;
    }
    vlSelf->fibonacci_generator__DOT__fib_prev2 = __Vdly__fibonacci_generator__DOT__fib_prev2;
