...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (vlSelfRef.reset) {
        ...
        vlSelfRef.top__DOT__CPU__DOT__reg_out = 0U;
        __Vdly__top__DOT__CPU__DOT__counter = 0U;
        vlSelfRef.done = 0U;
    } else {
        if (vlSelfRef.done) {
            vlSelfRef.__Vdly__top__DOT__FETCH__DOT__pc 
                = (0xffffU & ((IData)(1U) + (IData)(vlSelfRef.top__DOT__FETCH__DOT__pc)));
        }
        if ((3U == (IData)(vlSelfRef.top__DOT__CPU__DOT__counter))) {
            vlSelfRef.top__DOT__CPU__DOT__reg_out = vlSelfRef.top__DOT__CPU__DOT__reg_in;
            vlSelfRef.done = 1U;
            __Vdly__top__DOT__CPU__DOT__counter = 0U;
        } else {
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.top__DOT__instruction = vlSelfRef.top__DOT__FETCH__DOT__IM__DOT__memory
...
VL_INLINE_OPT void Vtop___024root___nba_comb__TOP__0(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.top__DOT__CPU__DOT__reg_in = (0xffffU 
                                            & ((4U 
                                                ...
                                                ? (
                                                   ...
                                                   ((1U 
                                                     ...
                                                     : 
                                                    (0xffU 
                                                     | (IData)(vlSelfRef.top__DOT__CPU__DOT__reg_out)))
                                                    : 
                                                   ((1U 
                                                     & (IData)(vlSelfRef.top__DOT__instruction))
                                                     ? 
                                                    VL_SHIFTR_III(16,16,32, (IData)(vlSelfRef.top__DOT__CPU__DOT__reg_out), 1U)
                                                     : 
                                                    VL_SHIFTL_III(16,16,32, (IData)(vlSelfRef.top__DOT__CPU__DOT__reg_out), 1U)))
                                                : (
                                                   (2U 
                                                    & (IData)(vlSelfRef.top__DOT__instruction))
                                                    ? 
